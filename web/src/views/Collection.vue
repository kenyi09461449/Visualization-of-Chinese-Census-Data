...
const Chart10 = async () => {
    ...
    option = {
        ...
        title: {
            text: 'Permanent population statistics by provinces and cities in 2023',
            subtext: 'Data from https://data.stats.gov.cn/',
            sublink: 'https://data.stats.gov.cn/',
            left: 'center',
        },
    ...
    <el-container>
        ...
        <el-container>
            <el-main class="el-main-fix">
                <div class="chart-tab" v-if="starList.includes('chart1')">
                    <div id="chart1" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart2')">
                    <div id="chart2" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart3')">
                    <div id="chart3" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart4')">
                    <div id="chart4" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart5')">
                    <div id="chart5" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart6')">
                    <div id="chart6" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart7')">
                    <div id="chart7" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart8')">
                    <div id="chart8" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart9')">
                    <div id="chart9" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart10')">
                    <div id="chart10" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart11')">
                    <div id="chart11" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart12')">
                    <div id="chart12" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart13')">
                    <div id="chart13" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart14')">
                    <div id="chart14" class="chart">

                    </div>
                </div>

                <div class="chart-tab" v-if="starList.includes('chart15')">
