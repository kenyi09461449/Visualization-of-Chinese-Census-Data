...
import {gdpAdd, gdpDelete, gdpList, gdpUpdate} from "@/api/gdp.js";
...
const getDataList = () => {
    gdpList(queryInfo.value).then((res) => {
        if (res.code === 200) {
...
const editUser = () => {
    gdpUpdate(editForm.value).then((res) => {
        if (res.code === 200) {
            getDataList()
...
<template>
    <el-container class="el-container-fix">
        ...
        <el-main>
            ...
            >
                ...
                <el-table-column prop="gdp" label="Gdp"></el-table-column>
    ...
    <el-dialog title="Add" v-model="addDialogVisible" width="30%">
        <el-form :model="addForm">
            ...
            <el-form-item prop="death">
                <el-input v-model="addForm.gdp" size="large" placeholder="Gdp" name="death"
    ...
    <el-dialog title="Edit" v-model="editDialogVisible" width="30%">
        <el-form :model="editForm">
            ...
            <el-form-item prop="death">
                <el-input v-model="editForm.gdp" size="large" placeholder="Gdp" name="death"
                          tabIndex="-1" auto-complete="on"></el-input>
            </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
