...
import {birthAdd, birthDelete, birthList, birthUpdate} from "@/api/birth.js";
...
const getDataList = () => {
    birthList(queryInfo.value).then((res) => {
        if (res.code === 200) {
...
const addUser = () => {
    birthAdd(addForm.value).then((res) => {
        if (res.code === 200) {
            getDataList()
...
const editUser = () => {
    birthUpdate(editForm.value).then((res) => {
        if (res.code === 200) {
            getDataList()
...
<template>
    <el-container class="el-container-fix">
        ...
        <el-main>
            ...
            >
                ...
                <el-table-column prop="birth" label="birth rate"></el-table-column>
                <el-table-column prop="death" label="death rate"></el-table-column>
                <el-table-column prop="up" label="up rate"></el-table-column>
    ...
    <el-dialog title="Add" v-model="addDialogVisible" width="30%">
        <el-form :model="addForm">
            ...
            <el-form-item prop="birth">
                <el-input v-model="addForm.birth" size="large" placeholder="Birth Rate" name="birth" tabIndex="-1"
                          auto-complete="on"></el-input>
            </el-form-item>
            <el-form-item prop="death">
                <el-input v-model="addForm.death" size="large" placeholder="Death Rate" name="death"
                          tabIndex="-1" auto-complete="on"></el-input>
            </el-form-item>
            <el-form-item prop="up">
                <el-input v-model="addForm.up" size="large" placeholder="Up Rate" name="up"
                          tabIndex="-1" auto-complete="on"></el-input>
            </el-form-item>
        </el-form>
    ...
    <el-dialog title="Edit" v-model="editDialogVisible" width="30%">
        <el-form :model="editForm">
            ...
            <el-form-item prop="birth">
                <el-input v-model="editForm.birth" size="large" placeholder="Birth Rate" name="birth" tabIndex="-1"
                          auto-complete="on"></el-input>
            </el-form-item>
            <el-form-item prop="death">
                <el-input v-model="editForm.death" size="large" placeholder="Death Rate" name="death"
                          tabIndex="-1" auto-complete="on"></el-input>
            </el-form-item>
            <el-form-item prop="up">
                <el-input v-model="editForm.up" size="large" placeholder="Up Rate" name="up"
                          tabIndex="-1" auto-complete="on"></el-input>
            </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
